declare module '@polkadot/types/lookup' {
    ...
    interface PalletOrderbookEvent extends Enum {
    ...
    interface PalletWyvernExchangeCoreEvent extends Enum {
    ...
    interface PalletWyvernExchangeCoreFeeMethod extends Enum {
    ...
    interface PalletWyvernExchangeCoreSide extends Enum {
        readonly isBuy: boolean;
        readonly isSell: boolean;
        readonly type: 'Buy' | 'Sell';
    }
    /** @name PalletWyvernExchangeCoreSaleKind (42) */
    interface PalletWyvernExchangeCoreSaleKind extends Enum {
    ...
    interface PalletWyvernExchangeCoreHowToCall extends Enum {
    ...
    interface PalletKittiesEvent extends Enum {
    ...
    interface PalletOrderbookCall extends Enum {
    ...
    interface PalletOrderbookOrderField extends Struct {
        readonly name: Bytes;
        readonly value: Bytes;
    }
    /** @name PalletWyvernExchangeCall (125) */
    interface PalletWyvernExchangeCall extends Enum {
    ...
    interface PalletWyvernExchangeCoreCall extends Enum {
    ...
    interface PalletKittiesCall extends Enum {
    ...
    interface PalletOrderbookOrderJSONType extends Struct {
        readonly index: u64;
        readonly orderId: Bytes;
        readonly owner: AccountId32;
        readonly fields: Option<Vec<PalletOrderbookOrderField>>;
    ...
    interface PalletOrderbookError extends Enum {
    ...
    interface PalletWyvernExchangeCoreError extends Enum {
    ...
    interface PalletKittiesKitty extends Struct {
    ...
    interface PalletKittiesGender extends Enum {
        readonly isMale: boolean;
        readonly isFemale: boolean;
        readonly type: 'Male' | 'Female';
    }
    /** @name PalletKittiesError (155) */
    interface PalletKittiesError extends Enum {
