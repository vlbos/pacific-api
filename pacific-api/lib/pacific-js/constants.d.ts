...
export declare const OPENSEA_FEE_RECIPIENT = "5DghaCqZ1zrx6hN8oGFWXLzrB6m2wV1CLLyWLHovdCrsu5W2";
export declare const DEP_INFURA_KEY = "e8695bce67944848aa95459fac052f8e";
export declare const LOCALNET_PROVIDER_URL = "ws://127.0.0.1:9944/";
export declare const MAINNET_PROVIDER_URL = "https://api.opensea.io/jsonrpc/v1/";
export declare const DEV_PROVIDER_URL = "https://dev-api.opensea.io/jsonrpc/v1/";
...
export declare const WYVERN_EXCHANGE_ADDRESS_DEV = "0x5206e78b21ce315ce284fb24cf05e0585a93b1d9";
...
export declare const CK_ADDRESS = "5FkmJ5zuMvqSGau2AGrwyz2ensv4ge6VHP2d8KenFpUXEEkJ";
export declare const CK_DEV_ADDRESS = "5FkmJ5zuMvqSGau2AGrwyz2ensv4ge6VHP2d8KenFpUXEEkJ";
export declare const WRAPPED_NFT_FACTORY_ADDRESS_MAINNET = "0xf11b5815b143472b7f7c52af0bfa6c6a2c8f40e1";
export declare const WRAPPED_NFT_FACTORY_ADDRESS_DEV = "0x94c71c87244b862cfd64d36af468309e4804ec09";
export declare const WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_MAINNET = "0x995835145dd85c012f3e2d7d5561abd626658c04";
export declare const WRAPPED_NFT_LIQUIDATION_PROXY_ADDRESS_DEV = "0xaa775Eb452353aB17f7cf182915667c2598D43d3";
export declare const UNISWAP_FACTORY_ADDRESS_MAINNET = "0xc0a47dFe034B400B47bDaD5FecDa2621de6c4d95";
export declare const UNISWAP_FACTORY_ADDRESS_DEV = "0xf5D915570BC477f9B8D6C0E980aA81757A3AaC36";
...
export declare const CHEEZE_WIZARDS_GUILD_DEV_ADDRESS = "0x095731b672b76b00A0b5cb9D8258CD3F6E976cB2";
export declare const CHEEZE_WIZARDS_BASIC_TOURNAMENT_ADDRESS: string;
export declare const CHEEZE_WIZARDS_BASIC_TOURNAMENT_DEV_ADDRESS = "0x8852f5F7d1BB867AAf8fdBB0851Aa431d1df5ca1";
...
export declare const STATIC_CALL_TX_ORIGIN_DEV_ADDRESS = "0xe291abab95677bc652a44f973a8e06d48464e11c";
export declare const STATIC_CALL_CHEEZE_WIZARDS_ADDRESS: string;
export declare const STATIC_CALL_CHEEZE_WIZARDS_DEV_ADDRESS = "0x8a640bdf8886dd6ca1fad9f22382b50deeacde08";
...
export declare const API_BASE_MAINNET = "http://localhost:8761";
export declare const API_BASE_DEV = "http://localhost:8761";
export declare const SITE_HOST_MAINNET = "http://localhost:8761";
export declare const SITE_HOST_DEV = "http://localhost:8761";
