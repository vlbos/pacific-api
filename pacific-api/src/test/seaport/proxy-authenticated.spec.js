...
describe("proxy Smart Contracts registry", function () {
    ...
    test.only("contractsContains", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.contractsContains(alicePair.address, { value: 0, gasLimit: -1 }, alicePair.address)];
                case 1:
    ...
    test.only("grantInitialAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    test("startGrantAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.startGrantAuthentication(bobPair.address, { value: 0, gasLimit: -1 }, alicePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // console.trace("==trace==")
    ...
    test("endGrantAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.endGrantAuthentication(bobPair.address, { value: 0, gasLimit: -1 }, alicePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // gas consumed
