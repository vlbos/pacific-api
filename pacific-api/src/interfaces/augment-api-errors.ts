...
declare module '@polkadot/api-base/types/errors' {
  export interface AugmentedErrors<ApiType extends ApiTypes> {
    ...
    substrateKitties: {
       ...
       **/
      BidPriceTooLow: AugmentedError<ApiType>;
      /**
       * You need to have two cats with different gender to breed.
       **/
      CantBreed: AugmentedError<ApiType>;
      /**
       * This kitty already exists!
       **/
      DuplicateKitty: AugmentedError<ApiType>;
      /**
       * This kitty does not exist!
       **/
      NoKitty: AugmentedError<ApiType>;
      /**
       ...
       **/
      TooManyOwned: AugmentedError<ApiType>;
      /**
    ...
    wyvernExchangeCore: {
      ...
      OnlyOwner: AugmentedError<ApiType>;
      OrderHashExists: AugmentedError<ApiType>;
      OrdersCannotMatch: AugmentedError<ApiType>;
      ProxyRegistryIsEmpty: AugmentedError<ApiType>;
      ...
      TokenTransferProxyIsEmpty: AugmentedError<ApiType>;
