...
export declare type ReplacementEncoder = (abi: any, kind?: FunctionInputKind, encodeToBytes?: boolean) => string;
export declare type AtomicizedReplacementEncoder = (abis: any, kind?: FunctionInputKind) => string;
