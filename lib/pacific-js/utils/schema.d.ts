...
export declare type Encoder = (schema: Schema<WyvernAsset>, asset: WyvernAsset, address: string, wyvernProtocol: WyvernProtocol, networkName: Network) => CallSpec;
export declare const encodeCall: (atomicizer: ContractPromise, parameters: any[]) => string;
