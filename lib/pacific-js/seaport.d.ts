...
import { FeeMethod, OpenSeaAPIConfig, OrderSide, UnhashedOrder, Order, UnsignedOrder, EventType, EventData, OpenSeaAsset, WyvernSchemaName, WyvernAsset, ComputedFees, Asset } from './types';
...
export declare class OpenSeaPort {
    ...
    init(provider: WsProvider): Promise<{
        api: ApiPromise;
    }>;
    createApiAndTestAccounts(provider: WsProvider): Promise<{
        api: ApiPromise;
    }>;
    closeProvider(): Promise<void>;
    initParameters(self: any, accountAddress: any): Promise<void>;
    apipro(): Promise<void>;
    /**
     ...
     */
    approveFungibleToken({ accountAddress, tokenAddress, proxyAddress, nonce, minimumAmount }: {
        accountAddress: string;
        tokenAddress: string;
        proxyAddress?: string;
        nonce?: string;
    ...
    encodeTransferAll({ assets, fromAddress, toAddress, schemaName }: {
        assets: Asset[];
        fromAddress: string;
        toAddress: string;
        schemaName?: WyvernSchemaName;
