...
describe("proxy Smart Contracts registry", function () {
    ...
    test.only("contractsContains", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, gasConsumed, result, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.contractsContains(alicePair.address, { value: 0, gasLimit: -1 }, charliePair.address)];
                case 1:
                    ...
                    if (result.isOk) {
                        console.log(bobPair.address, 'contractsContains Success', output === null || output === void 0 ? void 0 : output.toString());
                    }
                    else {
    ...
    test("getProxy", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, gasConsumed, result, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.getProxy(alicePair.address, { value: new bn_js_1["default"](0), gasLimit: new bn_js_1["default"](-1) }, alicePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log("outcome: ".concat(result.isOk ? 'Ok' : 'Error'));
                    console.log("gasConsumed ".concat(gasConsumed.toString()));
                    console.log(output === null || output === void 0 ? void 0 : output.toString(), "===========q=q==========", result.toString());
                    return [2 /*return*/];
            }
        });
    }); });
    test("owner", function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, gasConsumed, result, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.owner(alicePair.address, { value: new bn_js_1["default"](0), gasLimit: new bn_js_1["default"](-1) })];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log("outcome: ".concat(result.isOk ? 'Ok' : 'Error'));
                    console.log("gasConsumed ".concat(gasConsumed.toString()));
    ...
    test("grantInitialAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.grantInitialAuthentication(bobPair.address, { value: 0, gasLimit: -1 }, alicePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // gas consumed
                    ...
                    return [4 /*yield*/, contract.tx.grantInitialAuthentication({
                            value: 0,
                            gasLimit: gasLimit
    ...
    test.only("startGrantAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.startGrantAuthentication(bobPair.address, { value: 0, gasLimit: -1 }, charliePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // console.trace("==trace==")
                    ...
                    return [4 /*yield*/, contract.tx.startGrantAuthentication({
                            value: 0,
                            gasLimit: gasLimit
    ...
    test.only("endGrantAuthentication", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, contract.query.endGrantAuthentication(bobPair.address, { value: 0, gasLimit: -1 }, charliePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // gas consumed
                    ...
                    return [4 /*yield*/, contract.tx.endGrantAuthentication({
                            value: 0,
                            gasLimit: gasLimit
                        }, charliePair.address).signAndSend(bobPair)];
                case 2:
    ...
    test("transfer_ownership", function () { return __awaiter(void 0, void 0, void 0, function () {
        var gasLimit, _a, gasConsumed, result, output, output;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    gasLimit = new bn_js_1["default"](300000) * new bn_js_1["default"](1000000);
                    return [4 /*yield*/, contract.query.transferOwnership(bobPair.address, { value: 0, gasLimit: -1 }, alicePair.address)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result, output = _a.output;
                    console.log(result.toString());
                    // gas consumed
                    ...
                    return [4 /*yield*/, contract.tx.transferOwnership({
                            value: 0,
                            gasLimit: gasLimit
                        }, alicePair.address).signAndSend(bobPair)];
                case 2:
