...
describe("proxy Smart Contracts  ERC-20 ", function () {
    beforeAll(function () {
        contract = contracts["erc20"];
    });
    test(" ERC-20 contract   erc20 transfer", function () { return __awaiter(void 0, void 0, void 0, function () {
        var to, value, gasLimit, _a, gasConsumed, result, _b, gasConsumed, result, output, _c, gasConsumed, result, output;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    to = bobPair.address;
                    value = new bn_js_1["default"](10000000000);
                    gasLimit = new bn_js_1["default"](100000000);
                    return [4 /*yield*/, contract.query.transfer(davePair.address, { value: new bn_js_1["default"](0), gasLimit: new bn_js_1["default"](-1) }, to, value)];
                case 1:
                    _a = _d.sent(), gasConsumed = _a.gasConsumed, result = _a.result;
                    ...
                    return [4 /*yield*/, contract.tx.transfer({ value: 0, gasLimit: gasLimit }, to, value).signAndSend(davePair)];
                case 2:
                    _b = _d.sent(), gasConsumed = _b.gasConsumed, result = _b.result, output = _b.output;
                    console.log("=============ddd===d======", result);
                    return [4 /*yield*/, contract.query.balanceOf(to, { value: 0, gasLimit: -1 }, to)];
                case 3:
    ...
    test(" ERC-20 contract   erc20 approve", function () { return __awaiter(void 0, void 0, void 0, function () {
        var spender, value, gasLimit, _a, gasConsumed, result, txhash;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    spender = addresses["token"];
                    value = new bn_js_1["default"](1000000000000);
                    gasLimit = new bn_js_1["default"](100000000);
                    return [4 /*yield*/, contract.query.approve(bobPair.address, { value: new bn_js_1["default"](0), gasLimit: new bn_js_1["default"](-1) }, spender, value)];
                case 1:
                    _a = _b.sent(), gasConsumed = _a.gasConsumed, result = _a.result;
                    gasLimit = new bn_js_1["default"](gasConsumed.toString()) * new bn_js_1["default"](100);
                    console.log("outcome: ".concat(result.isOk ? 'Ok' : 'Error'));
                    console.log("gasConsumed ".concat(gasConsumed.toString()));
                    console.log("===========result=========", result.toString());
                    return [4 /*yield*/, contract.tx.approve({ value: 0, gasLimit: gasLimit }, spender, value).signAndSend(bobPair)];
                case 2:
                    txhash = _b.sent();
