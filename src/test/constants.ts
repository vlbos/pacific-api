...
export const DIGITAL_ART_CHAIN_ADDRESS = '5CMStp6FsUNjU78d9ET5VswnHkMtHR7rUCQQEmFBRNLUsqTL'
export const MYTHEREUM_ADDRESS = '5CthQsFsTxEkqdVozDf7QRV78jkkE23FRrnCoK7GWKCPMidc'
...
export const CK_DEV_BUNDLE_SLUG = 'puff-kitty'
export const WDOT_ADDRESS = '5Gc5PeAoQ6TQ7Buc9iXVsud8EZSabSbJyvk1hYK2rEx1eUN9'
export const WDOT_ADDRESS2 = '5ETSvcSaWLG6kKbXF3V7B5yGa8JVRG8TgdTRM3TXmhAz5ubF'
export const ENS_DEV_TOKEN_ADDRESS = '0x53ceb15b76023fbec5bb39450214926f6aa77d2e'
export const ENS_DEV_SHORT_NAME_OWNER = '0xe0ee13cd5a45e7fa140409edfc9ce17c7b11e6d2'
...
export const CK_DEV_TOKEN_ID = 1
export const CK_TOKEN_ID = 1
export const CRYPTOPUNKS_ID = 7858
export const CK_DEV_SELLER_FEE = 250
...
export const SANDBOX_DEV_ADDRESS = '0xcdeadfb2caa81d8c16d2935f3e379dda61242be9'
export const SANDBOX_DEV_ID = '44221324190444972628403853229966997983936414854632412290085204005353951330306'
...
export const BOB_ADDRESS = '5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty'
export const ALICE_STASH_ADDRESS = '5GNJqTPyNqANBkUVMN1LPPrxXnFouWXoe2wNSmmEoLctxiZY'
export const CHARLIE_ADDRESS = '5FLSigC9HGRKVhB9FiEo4Y3koPsNmBmLJbpXg2mp1hXcS59Y'
export const DAVE_ADDRESS = '5DAAnrj7VHTznn2AWBemMuyBwZWs6FNFjdyVXUeYum3PTXFy'
export const EVE_ADDRESS = '5HGjWAeFDfFCWPsjFQdVV2Msvz2XtMktvgocEZcCj68kUMaw'
