        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, client.wyvernExchange.orderCalldataCanMatchEx(buy.calldata, buy.replacementPattern, sell.calldata, sell.replacementPattern)];
                case 1:
                    result = _b.sent();
                    if (Number(result) > 0) {
                        return [2 /*return*/];
