...
export const devCryptoKittiesSchema: Schema<DevCryptoKittiesType> = {
  version: 1,
  deploymentBlock: 0,
  name: 'DevCryptoKitties',
  description: 'Dev Testnet CryptoKitties',
  ...
  formatter:
    async asset => {
      return {
        thumbnail: 'https://www.cryptokitties.co/images/kitty-eth.svg',
        title: 'DevCryptoKitty #' + asset,
        description: 'A Dev kitten!',
