...
import type { OrderId, OrderJSONType } from 'pacific-api/interfaces/orderbook';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    orderbook: {
      ...
      removedOrderCount: AugmentedQuery<ApiType, () => Observable<u64>, []>;
    };
    ...
    wyvernExchangeCore: {
      approvedOrders: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<bool>, [Bytes]>;
      cancelledOrFinalized: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<bool>, [Bytes]>;
      contractSelf: AugmentedQuery<ApiType, () => Observable<AccountId>, []>;
      exchangeToken: AugmentedQuery<ApiType, () => Observable<AccountId>, []>;
      minimumMakerProtocolFee: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
      minimumTakerProtocolFee: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
      nextOrderIndex: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []>;
      owner: AugmentedQuery<ApiType, () => Observable<AccountId>, []>;
